...
// const App2 = ({ editor } : { editor: Editor }) => {
const App2 = () => {
	...
	const exportPage = async (editor: any, meta: string, config1: any) => {		
		//event.preventDefault();
		console.log("EVENT EXPORT ------", config1)
        ...
        editor.Commands.add(commandName, {
            ...
            run(editor: PluginOptions = {}) {
                ...
                if (config.addExportBtn) {
                    ...
                    console.log("metaDescription inicial 2aaaaa  ------", config);
                    ...
                    editor.on('run:save-export', () => {
                        ...
                        btnExpExport.onclick = () => exportPage(editor, metaDescription, config)
                    });
                }
    ...
    //     console.log("EDITORRRRRRRRRRRR", editor)
    //     const pfx = editor.getConfig('stylePrefix');
    //     const commandName = 'save-export';
    ...
    //     editor.on('load', function() {
    //         editor.runCommand('core:component-outline');
    //         metaDesc1 = metaDescription;
    //         console.log("metaDesc1*************", metaDesc1)			
    //     });		
    ...
    //             if (config.addExportBtn) {
    //                 console.log("CONGIR---------- 2", metaDesc1)
    //                 const divButtonsModal = document.createElement('div');
    //                 divButtonsModal.className = 'buttons-group';
    ...
    //                         editor.Modal.close();
    //                     }
    //                     console.log("metaDescription inicial 2  ------", config);
    //                     let metaDesc = metaDescription
    //                     // btnExpExport.addEventListener('click', (event) => exportPage(editor, event));
    //                     btnExpExport.onclick = () => exportPage(editor, metaDesc, config)
    //                 });
    //             }
