const div = `
	...
	.card-vp-img-no-link .box-img img {
		object-fit: contain;
...
function ValuePrepositionImageDark4Col(editor: any) {		
	editor.Blocks.add('valuePrepositionImageDark4Col', {
		id: 'valuePrepositionImageDark4Col',
		label: 'With Image Dark 4 Col',
		activate: true,
		content: div,
...
export default ValuePrepositionImageDark4Col;