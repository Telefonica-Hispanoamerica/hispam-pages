...
function ValuePrepositionIconDarkLeft4Col(editor: any) {		
	editor.Blocks.add('valuePrepositionIconLeftDark4Col', {
		id: 'valuePrepositionIconLeftDark4Col',
		label: 'With Icon Left Dark 4 Col',
		activate: true,
		content: div,
...
export default ValuePrepositionIconDarkLeft4Col;